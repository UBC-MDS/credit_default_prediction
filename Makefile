...
# tune model
results/final_tuned_model.pkl results/default_lr_model.pkl results/random_search_cv_scores.csv: src/model.py data/preprocessed/transformed_train.csv data/preprocessed/transformed_test.csv
																								python src/model.py --train_path="data/preprocessed/transformed_train.csv" --test_path="data/preprocessed/transformed_test.csv" --out_dir="results/"

# create exploratory data analysis figure and write to file 
results/histogram_numeric_feat.png	results/categorical_feat_graph.png:	src/eda.py data/preprocessed/transformed_train.csv
																		python src/eda.py --file_path="data/preprocessed/transformed_train.csv" --out_dir="results/"
...
# render final report
doc/report.md: results/final_tuned_model.pkl results/default_lr_model.pkl results/random_search.png results/histogram_numeric_feat.png	results/categorical_feat_graph.png doc/report.Rmd doc/default_prediction_refs.bib
										 Rscript -e "rmarkdown::render('doc/report.Rmd')"

doc/report.html: results/final_tuned_model.pkl results/default_lr_model.pkl results/random_search.png results/histogram_numeric_feat.png	results/categorical_feat_graph.png doc/report.Rmd doc/default_prediction_refs.bib
