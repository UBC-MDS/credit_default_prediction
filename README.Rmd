...
If you wish to not use conda environment, please make sure you have all the dependencies and packages installed in your local machine, found [here](https://github.com/UBC-MDS/credit_default_prediction/blob/main/environment.yaml) before running these commands. 
