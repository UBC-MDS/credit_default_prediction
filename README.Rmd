...
```
docker run --rm -v /$(pwd):/home/rstudio/credit_default_prediction test1 make -C /home/rstudio/credit_default_prediction all
```

To reset the repo to a clean state, with no intermediate or results files, run the following command at the command line/terminal from the root directory of this project:

```
docker run --rm -v /$(pwd):/home/rstudio/credit_default_prediction test1 make -C /home/rstudio/credit_default_prediction clean
```
